...
class Environment:
    def __init__(self, all_cooked_time, all_cooked_bw, all_file_names, video_size_file, video_psnr_file, random_seed=RANDOM_SEED):
    ...
    def get_video_chunk(self, quality):
        ...
        while True:  # download video chunk over mahimahi
            ...
            # throughput *= np.random.uniform(NOISE_LOW, NOISE_HIGH)
