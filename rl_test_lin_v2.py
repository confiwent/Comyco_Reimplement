...
# TEST_TRACES = './envivo/traces/pre_webget_1608/test_traces/' # fcc_noisy/cooked_test_traces/'
# TEST_TRACES = './envivo/traces/traces_oboe/'
TEST_TRACES = './envivo/traces/fcc_noisy/cooked_test_traces/'
NN_MODEL = sys.argv[1]
